<?php
	...
	for($i=0;$i<count($pd);$i++){
		...
		echo "<button class='btn btn-outline-secondary btn-sm' id='eliminar_permiso' data-lugar='a_personal/personal_db' data-id='".$pd[$i]['idpermiso']."' data-funcion='borrapermiso'
