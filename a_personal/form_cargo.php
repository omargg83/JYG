<?php
	...
	if($idcargo>0){
		$cargox = $personal->cargoedit($idcargo);
		$cargo=$cargox['cargo'];
		
		$sql="select * from personal where idcargo='".$cargox['parentid']."'";
		$sup=$personal->general($sql);
...
<div class='modal-header'>
  ...
  <div class='modal-body' >
		<?php
			echo "<form id='form_comision' action='' data-lugar='a_personal/personal_db' data-funcion='guardar_cargo' data-destino='a_personal/editar' autocomplete='off'>";
