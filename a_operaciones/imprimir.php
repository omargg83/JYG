<?php
    ...
    $pdf->selectFont('../librerias15/fonts/Courier');
		...
		$pdf->addText(280,400,12,"Forma de pago:",200,'left');
		$pdf->addText(390,400,12,$row['forma'],200,'left');
		$pdf->addText(60,380,12,"Fecha:",200,'left');
		$pdf->addText(170,380,12,$row['fecha'],200,'left');

		$pdf->addText(60,340,12,"Clave Sat:",200,'left');
		$pdf->addText(170,340,12,$row['producto'],200,'left');
		$pdf->addText(60,320,12,"Descripción:",200,'left');
		$pdf->addText(170,320,12,$row['descripcion'],200,'left');
    ...
    $pdf->selectFont('../librerias15/fonts/Courier');
		...
		$pdf->addText(170,600,12,$row['monto'],200,'left');
		$pdf->addText(115,580,12,"TIPO DE RETORNO:",200,'left');
		$pdf->addText(240,580,12,$pers2['producto'],200,'left');
		...
		$pdf->addText(250,520,12,$row['empresa'],200,'left');

		$pdf->addText(115,500,12,"LUGAR DE ENTREGA:",200,'left');
		$pdf->addText(250,500,12,$row['lugar'],200,'left');
