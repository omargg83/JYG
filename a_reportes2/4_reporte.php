...
?>
<form id='consulta_avanzada' action='' data-destino='a_reportes2/4_res' data-div='resultado' data-funcion='reporte_4' autocomplete='off'>
  <div class='container' >
    <div class='jumbotron'>
      <h5><center>Gastos por Periodo</center></h5>
      <div class='row'>
        <div class='col-sm-3'>
            <label>Del</label>
