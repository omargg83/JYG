...
?>
<form id='consulta_avanzada' action='' data-destino='a_reportes/1_res' data-div='resultado' data-funcion='reporte_1' autocomplete='off'>
  <div class='container' >
    <div class='jumbotron'>
      ...
      <div class='row'>
        <div class='col-sm-4'>
          <div class='btn-group'>
            <button title='Buscar' class='btn btn-outline-primary' id='buscar_canalizado' type='submit' id='lista_buscar'><i class='fa fa-search'></i><span> Buscar</span></button>
          </div>
        </div>
      </div>
